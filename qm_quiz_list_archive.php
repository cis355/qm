            ...
            <div class="row">
			    <p>
                   <!-- <a href="qm_quiz_create.php?" class="btn btn-success">Create Quiz</a>-->
					<a href="qm_quiz_list.php?per_id=<?php echo $_GET['per_id'];?>"  class="btn btn-secondary">View Quiz List</a>
                </p>
                ...
                <table class="table table-striped table-bordered" style="background-color: lightgrey !important">
                  ...
                  <?php
                   $sql = 'SELECT * FROM qm_quizzes WHERE per_id =' . 
				        $_GET['per_id'].' AND archive_flag = 1 ORDER BY quiz_name'; 
						


                   foreach ($pdo->query($sql) as $row) {
                            echo '<tr>';
                            echo '<td width=490>'. $row['quiz_name'] . '</td>';
